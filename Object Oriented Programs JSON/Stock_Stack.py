...
class Person:
    try:
        def __init__(self):
            with open("/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/stock.json", "r") as stock_jf:
                stock_jf = json.load(stock_jf)  # load() convert file into python from json

            self.stock_jf = stock_jf
            with open("/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/customers.json", "r") as person_json_value:
        ...
        def add_new_company(self):
            ...
            with open('/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/stock.json', 'w') as stock_jf:
        ...
        def buy_share(self,index,name):
            ...
            if self.person_json_value['Person'][index]["Total Balance"]> amount_pay:
                    ...
                    s1.push("B")
                    s1.show()
                    with open("/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/customers.json", "w") as jf:
        ...
        def sell_share(self,index,name):
            ...
            with open("/home/admin1/PycharmProjects/BridgeLabzDemo/JSON/stock.json", "w") as jf:
                self.stock_jf["Stock Report"][choice]["Number of Share"] = updated_stock_share
                jf.write(json.dumps(self.stock_jf,indent=2))
